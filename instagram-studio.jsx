...
export default function InstagramStudio() {
  ...
  async function generate(tool) {
    ...
    try {
      ...
      setResults((p) => ({ ...p, [tool.id]: "Something went wrong. Please try again." }));
    } finally {
  ...
  return (
    <div style={{ background: BASE.bg, minHeight: "100vh", color: BASE.text, fontFamily: "'DM Sans', system-ui, sans-serif" }}>
